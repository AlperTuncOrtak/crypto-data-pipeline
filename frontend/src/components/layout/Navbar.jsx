...
import {
  ...
  History, PlusCircle, Combine, GitCompare, Network, Star,
} from 'lucide-react'
...
export default function Navbar({ onWatchlistOpen, watchlistCount }) {
  const navigate = useNavigate()
      ...
      >
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <button
            ...
            style={{
              backgroundColor: watchlistCount > 0 ? 'rgba(245,166,35,0.08)' : 'var(--bg-surface)',
              border: watchlistCount > 0 ? '1px solid rgba(245,166,35,0.3)' : '1px solid var(--border)',
              color: watchlistCount > 0 ? 'var(--accent)' : 'var(--text-muted)',
              cursor: 'pointer',
            }}
            onMouseEnter={e => {
            ...
            onMouseLeave={e => {
              e.currentTarget.style.borderColor = watchlistCount > 0 ? 'rgba(245,166,35,0.3)' : 'var(--border)'
              e.currentTarget.style.color = watchlistCount > 0 ? 'var(--accent)' : 'var(--text-muted)'
            }}
          >
            <Star size={13} fill={watchlistCount > 0 ? 'var(--accent)' : 'none'} />
            <span>Watchlist</span>
            {watchlistCount > 0 && (
          ...
          {user ? (
            ...
            >
              {user.avatar ? (
                ...
                <div className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold" style={{ backgroundColor: 'var(--accent)', color: '#111' }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#111', border: '1px solid rgba(255,255,255,0.15)',
                cursor: 'pointer',
