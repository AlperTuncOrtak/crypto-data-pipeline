                ...
                <div className="flex items-baseline">
                  <span className="text-4xl font-semibold ">
                    ...
                    <NumberFlow
                      ...
                      className="text-4xl font-semibold inline-block mx-1"
                    />
                  </span>
                  ...
                  className={`w-full mb-6 p-4 text-xl rounded-xl cursor-pointer ${
                    plan.popular
                      ...
                      : plan.buttonVariant === "outline"
                        ? "bg-gradient-to-t from-neutral-950 to-neutral-600  shadow-lg shadow-neutral-900 border border-neutral-800 text-white hover:opacity-90"
                        : ""
                  }`}
                >
                  {plan.buttonText}
