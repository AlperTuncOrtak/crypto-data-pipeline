...
/* ─── 7. Algorithmic Edge ─── */
const CODE_LINES = [
  { text: "import { MarketMaker } from '@crypto/algo';", cls: "text-slate-500" },
  { text: "", cls: "" },
  { text: "const strategy = new MarketMaker({",         cls: "text-slate-300" },
  { text: "  pair: 'BTC/USDT',",                        cls: "text-white" },
  { text: "  riskFactor: 0.05,",                         cls: "text-slate-400" },
  { text: "  leverage: 10,",                             cls: "text-slate-400" },
  { text: "  aiSignals: true,",                          cls: "text-slate-300" },
  { text: "});",                                         cls: "text-slate-300" },
  { text: "",                                            cls: "" },
  { text: "strategy.execute(); // ✅ Running...",        cls: "text-white font-bold" },
];
...
function AlgoDemo() {
  ...
  return (
    <div ref={ref} className="relative rounded-[28px] bg-[#020817] border border-white/10 p-4 shadow-2xl overflow-hidden group">
      <div className="absolute inset-0 bg-white/5 blur-[80px] rounded-full pointer-events-none opacity-20 group-hover:opacity-30 transition-opacity" />
      <div className="relative z-10 bg-[#020817] rounded-2xl border border-white/5 p-5 shadow-inner">
        <div className="flex items-center gap-1.5 mb-4">
          <div className="w-2.5 h-2.5 rounded-full bg-white/20" />
          <div className="w-2.5 h-2.5 rounded-full bg-white/40" />
          <div className="w-2.5 h-2.5 rounded-full bg-white/80" />
          <span className="ml-2 text-[10px] text-slate-500 font-mono">algo-strategy.ts</span>
        </div>
...
const FEATURES: Feature[] = [
  ...
  { tag: "Portfolio",             title: "Portfolio Sync",          desc: "Automatically import trades via CSV or connect on-chain wallets for unified tracking across every chain. See your full net worth, allocation breakdown, and weekly P&L in one beautiful dashboard.",                                                                                                    bullets: ["Multi-chain wallet tracking", "CSV & exchange API import", "Real-time P&L breakdown"],             Demo: PortfolioDemo,  flip: true  },
  { tag: "Quantitative",          title: "Algorithmic Edge",        desc: "Utilize advanced quantitative metrics typically reserved for institutional trading desks — now simplified into an elegant UI. Build, test, and deploy automated strategies without writing a single line of code.",                                                                                     bullets: ["Visual strategy builder", "Backtested signal triggers", "One-click automation deploy"],            Demo: AlgoDemo,       flip: false },
];
