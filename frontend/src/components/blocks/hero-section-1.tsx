                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">NVIDIA</div>
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">COLUMN</div>
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">GITHUB</div>
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">NIKE</div>
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">LEMON</div>
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">LARAVEL</div>
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">LILLY</div>
                            <div className="flex justify-center items-center font-bold text-xl text-zinc-500">OPENAI</div>
                        </div>
                    </div>
                </section>
            </main>
