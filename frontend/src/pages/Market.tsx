...
export default function Market({ isWatched, toggleWatchlist }: any) {
  ...
  return (
    <div className="relative min-h-[100dvh] bg-[var(--bg-base)] text-[var(--text-main)] pt-24 pb-32 px-6 lg:px-12 overflow-x-hidden font-sans">
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-[var(--text-muted)] mt-2 font-medium">
              {filteredAndSorted.length.toLocaleString()} assets &middot; Page {page}/{totalPages || 1}
            </p>
          </div>
          <div className="flex items-center gap-2">
