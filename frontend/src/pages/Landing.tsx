...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white selection:bg-cyan-500/40 selection:text-white font-sans overflow-x-hidden relative">
      ...
      <motion.header 
        ...
        className="fixed top-0 left-0 right-0 z-50 px-6 lg:px-12 py-4 flex items-center justify-between border-b border-white/[0.05] bg-[#000000]/60 transition-all duration-300"
      >
        <Link to="/" className="flex items-center gap-3 group">
          <motion.div 
            whileHover={{ rotate: 180, scale: 1.1 }} 
            transition={{ type: "spring", stiffness: 200, damping: 10 }}
            className="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center text-[#000000] font-black text-xl shadow-[0_0_20px_rgba(34,211,238,0.4)]"
          >
            C
          </motion.div>
        ...
        <div className="flex items-center gap-6">
          ...
          {loading ? null : user ? (
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-full bg-cyan-400 text-[#000000] font-bold text-sm hover:bg-cyan-300 hover:shadow-[0_0_20px_rgba(34,211,238,0.4)] active:scale-95 transition-all"
            >
              Sign In
            </button>
          )}
