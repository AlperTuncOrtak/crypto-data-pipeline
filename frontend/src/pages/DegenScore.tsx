...
export default function DegenScore() {
  ...
  return (
    <div className="min-h-screen bg-[#020204] text-[var(--text-main)] font-sans relative flex flex-col items-center overflow-x-hidden selection:bg-[var(--accent)] selection:text-white pb-20">
      ...
      {/* Global noise - removed mix-blend-overlay */}
      <div className="fixed inset-0 pointer-events-none z-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.01]" />
      <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[radial-gradient(ellipse_at_center,rgba(168,85,247,0.08)_0%,transparent_70%)] rounded-full pointer-events-none" />
