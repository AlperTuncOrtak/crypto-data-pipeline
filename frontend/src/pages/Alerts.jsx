            ...
            <div className="flex flex-col gap-1">
              {FILTERS.map(f => (
                <button
                  ...
                  style={{
                    backgroundColor: filter === f.key ? 'rgba(245,166,35,0.1)' : 'transparent',
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: filter === f.key ? 'rgba(245,166,35,0.15)' : 'var(--bg-elevated)',
                      color: filter === f.key ? 'var(--accent)' : 'var(--text-muted)',
                    }}
                  >
                    {f.count}
            ...
            <div className="flex flex-col gap-1">
              {[
                ...
                <button
                  ...
                  style={{
                    backgroundColor: sortBy === s.key ? 'rgba(245,166,35,0.1)' : 'transparent',
