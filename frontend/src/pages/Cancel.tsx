  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white pt-32 pb-24 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        >
          <XCircle size={80} className="text-red-400 mb-6 drop-shadow-[0_0_20px_rgba(248,113,113,0.5)]" />
        </motion.div>

        <h1 className="text-4xl font-black tracking-tight mb-4 text-white">Payment Cancelled</h1>
        ...
        <button 
          ...
          className="px-8 py-4 rounded-full bg-white/10 border border-white/20 text-white font-semibold text-sm hover:bg-white/20 transition-colors flex items-center justify-center gap-2 w-full"
        >
